...
class SearchServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetSearchStats = channel.unary_unary(
                '/trusttune.search.SearchService/GetSearchStats',
                request_serializer=search__pb2.SearchStatsRequest.SerializeToString,
                response_deserializer=search__pb2.SearchStatsResponse.FromString,
                _registered_method=True)
...
class SearchServiceServicer(object):
    ...
    def GetSearchStats(self, request, context):
...
def add_SearchServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetSearchStats': grpc.unary_unary_rpc_method_handler(
                    servicer.GetSearchStats,
                    request_deserializer=search__pb2.SearchStatsRequest.FromString,
                    response_serializer=search__pb2.SearchStatsResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'trusttune.search.SearchService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('trusttune.search.SearchService', rpc_method_handlers)
...
class SearchService(object):
    ...
    def GetSearchStats(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/trusttune.search.SearchService/GetSearchStats',
            search__pb2.SearchStatsRequest.SerializeToString,
            search__pb2.SearchStatsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
