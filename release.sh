...
echo -e "${WHITE}   • macOS Intel:        releases/latest/download/KarmaPlayer-macOS-Intel.zip${RESET}"
echo -e "${WHITE}   • macOS Apple Silicon: releases/latest/download/KarmaPlayer-macOS-AppleSilicon.zip${RESET}"
echo -e "${WHITE}   • Windows:            releases/latest/download/KarmaPlayer-Windows.zip${RESET}"
echo -e "${WHITE}   • Linux:              releases/latest/download/KarmaPlayer-Linux.tar.gz${RESET}"
echo ""
